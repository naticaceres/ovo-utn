...
export default function InstitutionTypesPage() {
  ...
  const save = async () => {
    ...
    try {
      ...
      if (editing) {
        await updateInstitutionType(editing.id, payload);
      } else {
        await createInstitutionType({ nombre: name });
      }
      setShowModal(false);
      load();
    } catch {
  ...
  const remove = async () => {
    ...
    setDeleting(true);
    try {
      await deactivateInstitutionType(itemToDelete.id, itemToDelete.nombre);
    ...
    <div className={styles.container}>
      ...
      >
        ...
        <div style={{ fontSize: '14px', color: '#666' }}>
          ...
          <strong>{items.length}</strong> tipos
        </div>
      </div>
      ...
      {showModal && (
        <div className={styles.modalBackdrop}>
          <div className={styles.modal}>
            <h3>
              {editing
                ? 'Editar tipo de institución'
                : 'Agregar tipo de institución'}
            </h3>
            <Input
              label='Nombre'
              fullWidth
              ...
              <>
                <div style={{ marginTop: '16px' }}>
                  ...
                  >
                    ...
                    />
                    <span>Reactivar tipo (establecer fecha fin como null)</span>
                  </label>
                </div>
                    ...
                    {fechaFin &&
                      new Date(fechaFin) <
                        ...
                        >
                          ...
                          es anterior a hoy. El tipo se marcará como "Baja"
                          inmediatamente.
                        </div>
                      )}
                  </div>
                ...
                {fechaFin &&
                  ...
                  new Date(fechaFin) >=
                    ...
                    >
                      ...
                      tipo quedará inactivo después de esa fecha.
                    </div>
                  )}
                ...
                {reactivar && (
                  ...
                  >
                    ...
                    fecha fin y el tipo quedará activo nuevamente.
                  </div>
                )}
              </>
            )}
      ...
      <ConfirmDialog
        ...
        onConfirm={remove}
        title='Confirmar Eliminación de Tipo'
        message={
          <>
            <p>
            ...
            <p>
              Esta acción afectará a todas las instituciones que usen este tipo.
            </p>
          </>
        }
