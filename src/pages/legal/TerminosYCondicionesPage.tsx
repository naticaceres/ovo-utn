      ...
      <div className={styles.contactContainer}>
        <div className={styles.content}>
          <div className={styles.textSection}>
            ...
            <p>
              El usuario garantiza que toda la información aportada es verdadera
              y actual.
            </p>
            ...
            <p>
              No publicar contenidos ilícitos, discriminatorios o contrarios a
              la normativa.
            </p>
            ...
            <p>
              La plataforma no será responsable por decisiones tomadas
              únicamente con base en los resultados.
            </p>
            <p>
