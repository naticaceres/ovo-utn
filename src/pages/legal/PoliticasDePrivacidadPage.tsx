    ...
    <div className={styles.contactContainer}>
      <div className={styles.content}>
        <div className={styles.textSection}>
          ...
          <p>
            <strong>Uso de la Plataforma:</strong> respuestas de test, historial
            de resultados, fecha y hora de acceso, ingreso de información
          ...
          <p>
            Enviar comunicaciones relacionadas con las instituciones y carreras
          ...
          <p>
            Acceder, rectificar, suprimir o limitar el tratamiento de tus datos.
          </p>
          <p>Derecho al “olvido” o portabilidad.</p>
          <p>
            Para ejercerlos, escribe a ovo.app.legal@gmail.com; te responderemos
          ...
          <p>Domicilio: Ciudad de Mendoza, Provincia de Mendoza, Argentina.</p>
        </div>
      </div>
    </div>
  );
